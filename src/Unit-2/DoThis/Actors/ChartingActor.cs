...
namespace ChartApp.Actors
{
    public class ChartingActor : ReceiveActor, IWithUnboundedStash
    {
        ...
        /// <summary>
        /// Maximum number of points allowed in a series
        /// </summary>
        public const int MaxPoints = 250;

        /// <summary>
        /// Incrementing counter used to plot along the x-axis
        /// </summary>
        ...
        private void Paused()
        {
            ...
            Receive<TogglePause>(pause =>
            {
                ...
                // Put messages back in the mailbox for processing under new behavior
                Stash.UnstashAll();
            });
        }
